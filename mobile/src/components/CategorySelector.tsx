...
/** Scrollable grid of muscle group pill chips for multi-select exercise category. */
export function CategorySelector({ selected, onToggle }: CategorySelectorProps): React.JSX.Element {
  return (
    <View>
